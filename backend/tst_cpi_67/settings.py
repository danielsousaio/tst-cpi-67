"""
Django settings for tst_cpi_67 project.
...
WSGI_APPLICATION = 'tst_cpi_67.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_cpi_67 API",
    "DESCRIPTION": "API documentation for tst_cpi_67 App",
    "VERSION": "v1",
}
